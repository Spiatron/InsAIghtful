  ...
  return (
    <nav className="navbar navbar-expand-lg bg-black">
      <div className="container-fluid">
        <Link className="fs-1 lh-1 navbar-brand text-light btn btn-outline-warning" href="/" style={{fontFamily: "angrybird", fontSize: "25px"}}> Learnify</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <Link className="nav-link btn btn-secondary text-light font-monospace fw-bold" href="/gallery">Gallery</Link>
            </li>

            {/* Here we are using this session function so that user can only create the course when he is signed in  */}
            {session?.user && (
                <li className="nav-item">
                  <Link className="nav-link text-light btn btn-secondary font-monospace fw-bold" href="/create">Create Course</Link>
                </li>
            )}

            <li className="nav-item">
              <Link className="nav-link text-light btn btn-secondary font-monospace fw-bold" href="/settings">About-us</Link>
            </li>
          </ul>
        </div>
      </div>
