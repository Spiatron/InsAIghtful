...
const QuizCards = ({ chapter }) => {
  ...
  return (
    ...
    <div className="bg-black w-75 bg-opacity-50  rounded-4 p-2" style={{ height: "", width: "" }}  > {/*position-fixed top-0 end-0 p-3*/}
      <h5 className="fs-1 text-center text-capitalize fw-bold" style={{fontFamily: "angrybird", color: "#DEDEDE"}}>Concept Check</h5>
      <div className=" ">
              ...
              style={{
                backgroundColor:
                  QuestionState[question.id] === true
                    ...
                    ? "#ff0000"
                    : "",
                    fontFamily: "quando", color: "#E9EAEC",
                    fontSize: "14px"
                    
              }}
            >
              <h5 className='fs-5 fw-bold' style={{fontFamily: "asul", color: "#D0D2D7"}}>{question.question}</h5>
