      ...
      <div className="UpsideAboutUs">
        <div className="container content">
          ...
          <h1 className="para" style={{ fontFamily: "delius", color: "white" }}>
            Join{" "}
            <span className="mainWord" style={{ fontFamily: "circuitboard" }}>
              LEARNIFY
            </span>
            , where the complexity of learning meets the simplicity of discovery
          </h1>

          <hr
            className="flex-grow-1 bg-secondary"
            style={{ border: "1px solid #eff7f6" }}
          />
          <h5 style={{ fontFamily: "delius" }}>
            Revolutionize your educational experience with intelligent
            playlists, automated quizzes, and a touch of innovation, making
            every lesson an effortlessly enriching journey!"
          </h5>
        </div>
