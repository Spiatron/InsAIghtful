  ...
  return (
    <div className={style.coursepage} >
      ...
      <h5 className="text-capitalize">Through AI</h5>
        ...
        <div className=" rounded-3 fs-4 container bg-dark-subtle text-white w-75" style={{ fontFamily: "asul", color: "" }}>  {/* to make the background transperant use bg-transparent */}
